    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        ...
        <div className="page-wrapper">
          ...
          {activeTab === 'analytics' && <AnalyticsView metrics={metrics} loading={loading} />}
...
// DASHBOARD
// ==========================================================
function DashboardView({ metrics, incidents, loading, searchQuery, onTabChange, setSelectedReplayId }: any) {
...
// ==========================================================
function TracesView({ incidents, loading, searchQuery, onDelete, setSelectedReplayId }: any) {
...
// ==========================================================
function AnalyticsView({ metrics, loading }: any) {
